 ...
 */
public class SmallLightBlock extends FacingBlock implements NaissanceEBlock {
  ...
  public SmallLightBlock() {
    ...
    this.setDefaultState(this.getDefaultState().with(FACING, Direction.NORTH).with(LIGHT_LEVEL, 15));
  }

  @Override
  protected void appendProperties(StateManager.Builder<Block, BlockState> builder) {
    super.appendProperties(builder.add(FACING, LIGHT_LEVEL));
  }
